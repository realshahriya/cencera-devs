...
export function HeroSection() {
  return (
    ...
    >
      {/* 1. Animated Soft Code Background */}
      <CodeBackgroundCanvas variant="hero" />

      {/* 2. Full-Bleed Edge-to-Edge Glassmorphism Layer (Covers 100% Full Hero Section Width & Height) */}
      <div 
        className="absolute inset-0 w-full h-full pointer-events-none z-[1] transition-all duration-300"
        style={{
      ...
      <div className="container-cencera relative z-10 text-center max-w-5xl mx-auto flex flex-col items-center my-auto px-4 sm:px-6">
        ...
        {/* Subtitle */}
        <p
          className="text-sm sm:text-lg md:text-xl max-w-2xl mx-auto mb-8 sm:mb-10 leading-relaxed px-2 sm:px-0 text-[#1E293B] font-medium"
        >
        ...
        {/* Tactile Soft Glass Action Buttons */}
      ...
      >
        <span className="soft-pill !py-1 !px-3 text-[10px] tracking-widest font-mono">
          <Cpu size={12} className="text-[#1D4ED8]" /> SCROLL
        </span>
        <ChevronDown size={18} className="animate-bounce text-[#1D4ED8]" />
      </a>
